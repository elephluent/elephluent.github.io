...
$(document).ready(() => {
    ...
    let moduleName = //profile.preferredProgress[0];// || "Colors";// || 
    "Colors";
    ...
    flashcard.click(() => {
        ...
        } else {  // if english, flip to foreign
    ...
    shuffleBtn.click(() => {
        // shuffle words that haven't been studied yet or all previous words?
        // shuffleMap();
        // currList = translations;
...
// returns the foreign keyword
// function pickRandom(){
//     let index = Math.floor(Math.random() * Object.keys(currList).length);
//     return Object.keys(currList)[index];
// }
