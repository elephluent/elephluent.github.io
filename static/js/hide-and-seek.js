...
$(document).ready(() => {
    ...
    // let language = profile.preferredLanguage || window.sessionStorage.getItem("language");// || "Spanish";
    ...
    // } else {
        ...
        //     language: language,
        //     lessonType: "HideAndSeek"
        // };

        // $.post("/module/lesson/get-lesson", req, responseJSON => {
        //     spritesToAdd = JSON.parse(responseJSON);
            ...
            for (let objName in objects) {
                if (objects.hasOwnProperty(objName) && objects[objName].hasOwnProperty("image")) {
    ...
    function setup() {
        ...
        // let bgSprite = createPair(resources[bg.image].texture, resources["normal"].texture);
    ...
    function addSpriteFromObject(object, isBg) {
        ...
        // let sprite = new Sprite(resources[object.image].texture);
        let sprite = createPair(resources[object.image].texture, resources["normal"].texture);
        ...
        if (object.hasOwnProperty("clickText") && object.hasOwnProperty("isCorrect")) {
            // add onclick event
            displayInstructions();
...
function displayClickedObject(clicked) {
    ...
    $("#next").on("click", function() {
      ...
      // let profile = JSON.parse(window.localStorage.getItem("profile"));
      // if(window.sessionStorage.getItem("moduleName") === profile.preferredProgress[0]) {
      //   updateProgress("HideAndSeek", profile, "/dashboard");
      // }
      // else {
