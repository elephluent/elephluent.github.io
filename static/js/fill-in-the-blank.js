...
$(document).ready(() => {
    ...
    //     let req = {
        ...
        //     fitbMap = JSON.parse(responseJSON);
            ...
            nextBtn.click(() => {
                ...
                } else { // all sentences have been filled in (game over)
                    let d2 = new Date();
                    endTime = d2.getTime();
...
function displaySentence() {
    ...
    sent.text(fitbMap[keywords[index]][0] + "________"
...
function optionClicked(option, choice) {
    ...
    if (!correctOptionSelected && selectedOptions.indexOf(choice.text()) === -1) {
        ...
        if (choice.text() === keywords[index]) {
            ...
            sent.text(fitbMap[keywords[index]][0] + " "
                + keywords[index] + " " + fitbMap[keywords[index]][1]);
